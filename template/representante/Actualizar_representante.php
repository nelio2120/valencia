...
//ASI SE GENERAN INPUTS
    ...
    print $javascript1;
    print FORM::GENERAR_INPUT_USUARIO("nombre",$datos['Nombre'],"Ingrese su nombre","text","Nombre","","onkeypress=\"return soloLetras(event)\"");
    print FORM::GENERAR_INPUT_USUARIO("apellido",$datos['Apellido'],"Ingrese su apellido","text","Apellido","","onkeypress=\"return soloLetras(event)\"");
    ...
    print FORM::GENERAR_INPUT_USUARIO("direccion",$datos['direccion'],"ingrese su direccion","text","Direccion","","onkeypress=\"return soloLetras(event)\"");
    print FORM::GENERAR_INPUT_USUARIO("fecha_nacimiento",$datos['fecha_nacimiento'],"Ciudad","date","Fecha de Nacimiento");
    print FORM::GENERAR_INPUT_USUARIO("sector",$datos['sector'],"Ingrese el sector","text","Sector","","onkeypress=\"return soloLetras(event)\"");
