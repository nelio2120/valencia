...
$array_encabezado = array("Nombre","Descripcion","Nivel");
$array_detalle = BDD::QUERY("select ejercicio.nombre, descripcion,nivel.nombre as n ,id_ejercicio from ejercicio 
