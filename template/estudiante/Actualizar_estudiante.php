...
$datos = BDD::CONSULTAR("estudiante","id_estudiante,id_persona,id_nivel,id_entrenador,club","id_estudiante=$id");
...
//Y ESTAS LAS ABREN (OBLIGATORIAS)
    ...
    print FORM::GENERAR_SELECT($array,"select","Persona",$datos['id_persona']);
    ...
    print FORM::GENERAR_SELECT($array3,"select","Entrenador",$datos['id_entrenador']); 
