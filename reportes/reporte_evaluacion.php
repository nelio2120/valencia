...
where d.idevaluacion_aspirante = $id and d.tipo = 'C'");
    ...
    <div style="margin-left: 20px;margin-top: 20px;">
       <h1 align="left">HABILIDADES FISICAS DEL HOMBRE</h1>
        ...
        <label class="small mb-5">Ciudad: <?php echo $datos['ciudad'] ?></label> <br>
        <label class="small mb-5">Nac: <?php echo $datos['edad'] ?></label> <br>
        <label class="small mb-5">Club: <?php echo $datos['club'] ?></label><br>
        <label class="small mb-5">Fecha: <?php echo $datos['fecha'] ?></label> <br>
    </div>
    <br>
    <div style="width: 500px;">
        <h4 style="margin-left: 20px;">Flexibilidad</h4>
        <table class="table-primary" border="1" >
            ...
            <?php
                $td = "";
                $i = 1;
                foreach ($flexibilidad as $k){
                    $td .= "<tr>";
                    $td .= "<td>$i</td>";
                    foreach ($k as $k=>$v){
                        if(substr($k,0,5)=="total") continue;
                        $td .= "<td>$v</td>";
                    }
                    $td .= "</tr>";
                    $i++;
        ...
        <br><br>
        <h4 style="margin-left: 20px;">Fuerza</h4>
        <table class="table-primary" border="1" >
            <thead>
            <tr>
                <th style="width: 100px;"></th>
