...
class classPersona
{
    ...
    static public function ELIMINAR_PERSONA(){
        ...
        if(BDD::ELIMINAR_DATOS("persona","id_persona = $name_id")) return print classUsuario::REDIRECCIONAR_ANTERIOR();
        else print "<script>alert('Error al Eliminar,Revise si tiene Relacion con Usuario o otro tipo de error');</script>";
    }
